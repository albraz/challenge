...
public class ProductTypeTest {
    ...
    void should() {
        ...
        assertThat(ProductType.RESIDENCIAL.getFee(new BigDecimal(100.00))).isEqualTo(new BigDecimal("107"));
        assertThat(ProductType.PATRIMONIAL.getFee(new BigDecimal(100.00))).isEqualTo(new BigDecimal("108"));
    }
}
