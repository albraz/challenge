...
public class Message {
    ...
    public static final String CREATE_PRODUCT = "Criando produto";
    public static final String UPDATE_PRODUCT = "Atualizando produto";
    public static final String GET_PRODUCTS = "Recuperando produtos";
    public static final String GET_PRODUCT_BY_ID = "Recuperando produto por id";
}
